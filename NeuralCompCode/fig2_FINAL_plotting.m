...
fig2.OuterPosition=[0,0,14.65,11.7];
...
sC.FontSize=fsBig;
legend(addedlines,{'$E[a_n|\epsilon]$','$E[a_n|\xi_{1:n}]$'},...
    'Position',[.64,.85,.07,.1],...
    'Interpreter','latex')
legend('boxoff');
...
hold off
sD.LineWidth=spax;
legend(otheraddedLines,{'$\epsilon$','$E[\epsilon|\xi_{1:n}]$'},...
    'Position',[.67,.29,.07,.1],...
    'Interpreter','latex')
legend('boxoff');
%sD.Position=pB
...
sC.OuterPosition=[.465+tiny,0.393,.535,0.602];
sD.OuterPosition=[.47+tiny,0,.53,.44];
